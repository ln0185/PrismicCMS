...
/**
 * @typedef {import("@prismicio/client").Content.CustomerLogos2Slice} CustomerLogos2Slice
 *
 * @typedef {import("@prismicio/react").SliceComponentProps<CustomerLogos2Slice>} CustomerLogos2Props
 *
 * @type {import("react").FC<CustomerLogos2Props>}
 */
const CustomerLogos2 = ({ slice }) => {
  return (
    <section
