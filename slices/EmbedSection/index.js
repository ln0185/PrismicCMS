 ...
 * @type {import("react").FC<EmbedSectionProps>}
 */
...
const EmbedSection = ({ slice }) => {
  return (
    ...
    >
      <div
        className={`grid justify-center items-center text-center w-screen h-screen ${slice.primary.background_color ? backgroundColor[slice.primary.background_color] : backgroundColor.Grey}`}
      >
